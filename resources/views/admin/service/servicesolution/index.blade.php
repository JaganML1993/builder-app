...
<div class="main-content">
    <section class="section">
        <div class="section-body">
            <div class="row">
              <a href="{{ route('admin.service.servicesolution.create',$id)}}" class="btn btn-success mb-2 mr-2" style="margin-left: 15px !important;"><i class="fa fa-plus" aria-hidden="true"></i>
                Create</a>
                          ...
                          @if (isset($services) && !empty($services))
                              ...
                              @foreach($services as $service)
                                    ...
                                    <td class="text-center" style="display: flex;">
                                      ...
                                      <form action="{{ route('admin.service.servicesolution.delete',$service->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
