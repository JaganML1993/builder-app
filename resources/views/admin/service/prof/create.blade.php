...
<div class="main-content">
  <section class="section">
    <div class="section-body">
      <div class="row">
        <a href="{{ route('admin.service.professional.index',$id)}}" class="btn btn-primary mb-2 mr-2" style="margin-left: 15px !important;"><i class="
            fas fa-arrow-left"></i>
          Back</a>
          {{-- @if ($errors->any())
        ...
        <div class="col-12">
          <div class="card">
            <form method="POST" action="{{ route('admin.service.professional.store',$id) }}" enctype="multipart/form-data">
              @csrf
              <div class="card-header">
                <h4>Create Professional Service</h4>
              </div>
              ...
              <div class="card-body">
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-6">
                    ...
                    <p class="mt-2 text-danger">(Only Supports jpg.jpeg,png,svg formats, Size 50*50 px)</p>
                  </div>
