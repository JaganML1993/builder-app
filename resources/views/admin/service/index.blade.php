...
<div class="main-content">
  <section class="section">
    <div class="section-body">
      <div class="row">
        <a href="{{ route('admin.service.create')}}" class="btn btn-success mb-2 mr-2" style="margin-left: 15px !important;"><i class="fa fa-plus" aria-hidden="true"></i>
          Create New Page</a>
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <!-- filter starts -->
              <form action="{{ route('admin.service.index') }}" id="filterForm" method="GET">
                <div class="row">
                  <div class="col-2">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center" style="display: flex;">
                        <a href="{{ route('admin.service.publish',$service->id) }}" class="btn btn-primary" style="margin-right: 12px !important;" onclick="if (confirm('Are you sure you want to publish the page?')) { this.closest('form').submit(); } return false;">Publish</a>
                        <a href="{{ route('admin.service.edit',$service->id) }}" class="btn btn-primary" style="margin-right: 12px !important;">Edit</a>
                       ...
                       @else
                        ...
                        <form action="{{ route('admin.service.delete',$service->id)}}" method="post">
                          @csrf
                          @method('DELETE')
                          <a href="#" class="btn btn-danger confirmation" title="Delete" data-toggle="tooltip" onclick="if (confirm('Are you sure you want to delete this?')) { this.closest('form').submit(); } return false;">
