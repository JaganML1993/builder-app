  ...
  <section class="section">
    <div class="section-body">
      <div class="row">
        ...
        <div class="col-12">
          <div class="card">
            <form method="POST" action="{{ route('admin.sub-service-list.update') }}">
              @csrf
              <div class="card-header">
                <h4>Edit Sub Folder</h4>
              </div>
                ...
                <div class="form-group row mb-4 color-one">
                  ...
                  <div class="col-6 mb-4">
                    ...
                    <select name="services_list_id" class="form-control col">
                      ...
                      <option value="{{$service->id}}" @if($serviceDetail->service->id == $service->id) selected @endif>{{$service->name}}</option>
                      @endforeach
                    </select>
                  </div>
                  <div class="col-6 mb-4">
                    <label class="">Sub Folder Name<span class="text-danger">*</span></label>
                    <input type="text" name="name" class="form-control col" value="{{ $serviceDetail->name }}">
                    @if ($errors->has('name'))
                  ...
                  <div class="col-6 mb-4">
                    ...
                    <select name="status" class="form-control col">
                      <option value="1" {{ $serviceDetail->status == 1 ? 'selected' : '' }}>Active</option>
                      <option value="0" {{ $serviceDetail->status == 0 ? 'selected' : '' }}>Inactive</option>
                    </select>
